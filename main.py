...
source_data = pd.read_csv("data/sp500_data.csv", parse_dates=["Date"])
...
ticker1 = AutocompleteInput(title="Change Ticker Values Below:", value="AAPL", completions=nix("GOOG", DEFAULT_TICKERS),
                            case_sensitive=False)
ticker2 = AutocompleteInput(title="Change Ticker Values Below:", value="GOOG", completions=nix("AAPL", DEFAULT_TICKERS),
                            case_sensitive=False)
